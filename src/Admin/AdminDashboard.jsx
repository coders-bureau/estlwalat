...
import { getAllProductsData, getProducts, getProductsData } from "../Redux/AppReducer/Action";
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    //   },
    // };
    // dispatch(getProducts(getMensData));
    // dispatch(getProducts(getWomenData));
    // dispatch(getProducts(getKidsData));
          ...
          <Box display={{ lg: "none", md: "none", base: "block" }}>
            <Chart
              ...
              options={{
                ...
                xaxis: {
                  categories: ["Kids Products", "Mens Products", "Women Products",],
                },
              }}
            />
          </Box>
