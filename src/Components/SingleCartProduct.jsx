import { Box, HStack,Grid, Tag, VStack ,Image,Text,Icon, Menu, MenuButton, MenuList, MenuItem, MenuItemOption, MenuGroup, MenuOptionGroup, MenuDivider, Button, Select, border, useToast,
...
const handleDelete=()=>{
  ...
  return (
<>
<Grid templateColumns={{lg:"1fr 3fr 20px", md:"1fr 3fr 20px", sm:"1fr 3fr 20px"}} textAlign="left" gap="5px" w="full" border={"2px solid #b0a9a9"} borderRadius="5px">
